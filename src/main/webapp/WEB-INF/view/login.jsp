...
<body class="login-layout">
										...
										<form id="user-login-form">
											<fieldset>
												...
												<div class="clearfix">
													...
													<button type="button" id="login-but"
									...
									<div class="widget-main">
										...
										<form id="user-register-form">
											<fieldset>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> 
													<input name="userMobileNo" type="text" class="form-control" placeholder="PhoneNo" />
												...
												<label id="passwordError" style="display: none;">
												...
												<div class="clearfix">
													...
													<button id="register-but" type="button"
	...
	<script type="text/javascript" src="${ctx}/assets/js/lt/login.js"></script>
</body>
</html>